...
public class UserIntegraExchange implements Serializable {
    ...
    private BigDecimal integraPrice;
    ...
    public BigDecimal getIntegraPrice() {
        return integraPrice;
    }

    public void setIntegraPrice(BigDecimal integraPrice) {
