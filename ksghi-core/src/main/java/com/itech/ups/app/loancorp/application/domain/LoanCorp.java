package com.itech.ups.app.loancorp.application.domain;

import java.io.Serializable;
import java.math.BigDecimal;

public class LoanCorp implements Serializable {

    private static final long serialVersionUID = 5594237125913070711L;
