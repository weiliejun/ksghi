...
public final class ExpExcelHelper {
    ...
    public static void expExcel(HttpServletRequest request, HttpServletResponse response, List datas, String[] heads, String reportTitle, String sheeTTitle, String fileName) {
        ...
        try {
            ...
            jxl.write.WritableFont wf = new jxl.write.WritableFont(jxl.write.WritableFont.createFont("宋体"), 10, jxl.write.WritableFont.NO_BOLD, false);
            // 设置CellFormat
            jxl.write.WritableCellFormat wcfF = new jxl.write.WritableCellFormat(wf);
            jxl.write.WritableFont wfHeader = new jxl.write.WritableFont(jxl.write.WritableFont.ARIAL, 11, jxl.write.WritableFont.BOLD, false);
            // 设置CellFormat
            ...
            // jxl.format.Colour.BLACK);// 设置边框
            // wcfFHeader.setBorder(jxl.format.Border.ALL, BorderLineStyle.THIN,
            // jxl.format.Colour.BLACK);// 设置边框
            ...
            if (reportTitle != null && reportTitle.length() > 0) {
                ...
                labelCF0 = new jxl.write.Label(0, count, reportTitle, wcfF);
                ws.addCell(labelCF0);
                count += 2;
            }
