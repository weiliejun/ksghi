...
public class QRCodeUtil {
    ...
    public static void encode(String content, String imgPath, String destPath, String fileName) throws Exception {
        QRCodeUtil.encode(content, imgPath, destPath, fileName, true);
    }
    ...
    public static void main(String[] args) throws Exception {
        String text = "http://192.168.1.90:9999/ksghi-customerPC/install";
        QRCodeUtil.encode(text, "C:/Users/Administrator/Desktop/logn.png", "C:/Users/Administrator/Desktop/", "1235", true);
    }

    public void write(OutputStream sos, String content, String imgPath, boolean needCompress) throws ImageFormatException, Exception {
        // ImageIO.write(buffImg, "png", sos);
        // sos.close();
        JPEGImageEncoder encoder = JPEGCodec.createJPEGEncoder(sos);
        encoder.encode(QRCodeUtil.createImage(content, imgPath, needCompress));
    }
}