 ...
 * 导出带子sheet的excel
 */
public final class ExpExcelFKHelper {
    ...
    public static void expExcel(HttpServletRequest request, HttpServletResponse response, String excelName, String sheetName, String pDescription, String[] pTitle, List<Map<String, Object>> list, String[] cTitle, String statistical) {
        ...
        try {
            ...
            jxl.write.WritableFont wfHeader = new jxl.write.WritableFont(jxl.write.WritableFont.ARIAL, 13, jxl.write.WritableFont.BOLD, false);// 列标题
            ...
            jxl.write.WritableFont wfCell = new jxl.write.WritableFont(jxl.write.WritableFont.createFont("宋体"), 12, jxl.write.WritableFont.NO_BOLD, false);// 设置写入字体
            jxl.write.WritableFont wfCell1 = new jxl.write.WritableFont(jxl.write.WritableFont.createFont("宋体"), 24, jxl.write.WritableFont.NO_BOLD, false);// 设置写入字体
            jxl.write.WritableFont wfCell2 = new jxl.write.WritableFont(jxl.write.WritableFont.createFont("宋体"), 14, jxl.write.WritableFont.NO_BOLD, false);// 设置写入字体
            jxl.write.WritableCellFormat wcfL2 = new jxl.write.WritableCellFormat(wfCell2);// 居左
            wcfL2.setVerticalAlignment(jxl.format.VerticalAlignment.CENTRE);// 垂直居中
            wcfL2.setAlignment(Alignment.LEFT);// 水平居左
            wcfL2.setWrap(true);
            ...
            wcfC.setWrap(true);
            jxl.write.WritableCellFormat wcfC1 = new jxl.write.WritableCellFormat(wfCell1);// 居中
            wcfC1.setVerticalAlignment(jxl.format.VerticalAlignment.CENTRE);
            wcfC1.setAlignment(Alignment.CENTRE);
            wcfC1.setWrap(true);
             ...
             * 标题
             */
            jxl.write.Label labelCF1 = null;
            ws.mergeCells(0, count, titleCount, 1);
            labelCF1 = new jxl.write.Label(0, count, "放款凭证", wcfC1);
            ws.addCell(labelCF1);
            ws.setRowView(0, 400);
            count += 2;

            if (pDescription != null && statistical.length() > 0) {
                jxl.write.Label labelCF2 = null;
                ws.mergeCells(0, count, titleCount, 1);
                labelCF2 = new jxl.write.Label(0, count, statistical, wcfL2);
                ws.addCell(labelCF2);
                ws.setRowView(2, 400);
                count += 1;
            }
