...
import com.itech.core.util.exception.ParamErrorException;
...
public class VerifyUtil {
     ...
     */
    public static boolean validateParamInterface(JSONObject data, VerifyUtil.InterfaceName defaultverify) {
        ...
        try {
            switch (params.length) {
                case 1:
                    ...
                    break;
                case 2:
                    method = VerifyUtil.class.getMethod(params[0], new Class[]{java.lang.String.class});
                    flag = (Boolean) method.invoke(null, params[1]);
                    break;
                case 3:
                    method = VerifyUtil.class.getMethod(params[0], new Class[]{java.lang.String.class, java.lang.String.class});
