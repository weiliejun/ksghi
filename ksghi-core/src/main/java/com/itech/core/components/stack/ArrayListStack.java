package com.itech.core.components.stack;
 ...
 *
 * @author Jack chen
 * @see java.util.Stack reference Commons Collections ArrayStack
 */
public class ArrayListStack extends ArrayList implements Buffer {
     ...
     */
    public ArrayListStack(int initialSize) {
        super(initialSize);
    }
