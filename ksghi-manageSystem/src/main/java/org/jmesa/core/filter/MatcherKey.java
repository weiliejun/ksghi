...
/**
 * <p>
 * Able to match up values based on a class type and column property. The class
 * type is required. The column property is optional and is also used to match
 * up to a more specific filter.
 * </p>
 *
 * <p>
