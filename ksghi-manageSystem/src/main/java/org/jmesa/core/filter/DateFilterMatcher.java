...
public class DateFilterMatcher extends AbstractPatternFilterMatcher {
    ...
    public boolean evaluate(Object itemValue, String filterValue) {
        ...
        if (pattern == null) {
            logger.debug("The filter (value " + filterValue + ") is trying to match against a date column using " + "the DateFilterMatcher, but there is no pattern defined. You need to register a DateFilterMatcher " + "to be able to filter against this column.");
            return false;
        }
