...
public class StringWildCardFilterMatcher implements FilterMatcher {
    ...
    /**
     * Creates a simple regexp pattern out of filterStr, replacing wildcards ?
     * and * with the matching regular expression components.
     *
    ...
    private Pattern createFilterPattern(String filterStr) {
        ...
        // for usability reasons, automatic wildcard to end of the word. The
        // user can just filter
