...
/**
 * <p>
 * The CoreContext encapsulates the core package and is used to Filter and Sort
 * the items. It also gives easy access to the Preferences and Messages as well
 * as a reference to the Limit.
 * </p>
 *
