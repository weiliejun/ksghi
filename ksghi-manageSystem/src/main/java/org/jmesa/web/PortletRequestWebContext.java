 ...
 * <p>
 * By default, session attributes are stored in APPLICATION_SCOPE. This behavior
 * can be overriden during construction or using setSessionScope().
 *
 * @author bgould
 * @version 2.3.4
 */
public class PortletRequestWebContext implements WebContext {
    ...
    /**
     * <p>
     * Creates a WebContext from the given portlet request. Note that this
