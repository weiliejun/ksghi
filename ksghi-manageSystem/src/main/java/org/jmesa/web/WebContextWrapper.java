...
/**
 * <p>
 * A general-purpose decorator object for a WebContext. By default, all methods
 * delegate to the underlying WebContext. Subclasses can override this default
 * behavior to mix in functionality to an existing context.
 * </p>
 *
 * @author bgould
 * @version 2.3.4
