...
import org.jmesa.view.html.renderer.*;
...
class TagUtils {
    ...
    static List<WorksheetValidation> getWorksheetValidations(HtmlColumn column, String worksheetValidation, String errorMessageKey, String errorMessage, boolean custom) {
        ...
        Map<String, String> worksheetValidations = getNameValueMap(worksheetValidation, "Required format of worksheetValidation / customWorksheetValidation is \"validationType:value;[second pair]\"");
