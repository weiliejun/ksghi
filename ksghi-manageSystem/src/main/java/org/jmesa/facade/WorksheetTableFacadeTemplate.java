...
/**
 * Extends the TableFacadeTemplate to add support for the worksheet.
 * Specifically this will automatically add and remove rows and offer a callback
 * method called saveWorksheet() so that a worksheet can be saved before
 * rendering the new table.
 *
