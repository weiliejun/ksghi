...
final class TableFacadeExceptions {
    ...
    static void validateColumnPropertiesIsNotNull(String[] columnProperties) {
        if (columnProperties == null || columnProperties.length == 0) {
            throw new IllegalStateException("The table is null. You need to set the table on the facade (or model).");
        }
    }

    static void validateCoreContextIsNull(CoreContext coreContext, String object) {
        if (coreContext != null) {
            throw new IllegalStateException("It is too late to set the " + object + ". You need to set the " + object + " before using the CoreContext.");
        }
    }
    ...
    static void validateLimitIsNull(Limit limit, String object) {
        if (limit != null) {
            throw new IllegalStateException("It is too late to set the " + object + ". You need to set the " + object + " before using the Limit.");
        }
    }
    ...
    static void validateTableIsNull(Table table, String object) {
        if (table != null) {
            throw new IllegalStateException("It is too late to set the " + object + ". You need to set the " + object + " before using the Table.");
        }
    }

    static void validateToolbarIsNull(Toolbar toolbar, String object) {
        if (toolbar != null) {
            throw new IllegalStateException("It is too late to set the " + object + ". You need to set the " + object + " before using the Toolbar.");
        }
    }

    static void validateViewIsNull(View view, String object) {
        if (view != null) {
            throw new IllegalStateException("It is too late to set the " + object + ". You need to set the " + object + " before using the View.");
        }
    }
}
