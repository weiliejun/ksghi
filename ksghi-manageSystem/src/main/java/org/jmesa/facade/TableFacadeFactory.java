 ...
 * @since 2.2
 * @deprecated For internal use only. Use the new TableModel for building
 * tables.
 */
@Deprecated
public class TableFacadeFactory {
    ...
    /**
     * @deprecated For internal use only. Use the new PortletTableModel for
     * building tables.
     */
    @Deprecated
    ...
    /**
     * @deprecated For internal use only. Use the new SpringPortletTableModel
     * for building tables.
     */
    @Deprecated
    ...
    /**
     * @deprecated For internal use only. Use the new SpringTableModel for
     * building tables.
     */
    @Deprecated
    ...
    /**
     * @deprecated For internal use only. Use the new Struts2TableModel for
     * building tables.
     */
    @Deprecated
