 ...
 *
 * <p>
 * The TableFacade also has setters for all the facade objects including the
 * WebContext, CoreContext, Limit, Table, Toolbar, and View. The reason is if
 * you really need to customize something and want to set your own
...
public class TableFacade {
    ...
    /**
     * Add a FilterMatcher on the facade. This will override the FilterMatcher
    ...
    /**
     * <p>
     * Add a FilterMatcherMap on the facade. Will add the various FilterMatchers
     * to the facade using the FilterMatcherMap interface.
     * </p>
     *
     * <p>
     * Most useful for the tag library because they have to use the
     * FilterMatcherMap to register filter matcher strategies, but could also be
     * used as a way to bundle up filter matchers.
     * </p>
     */
     ...
     *
     * @param autoFilterAndSort True if should sort and filter the Collection of Beans (or
     *                          Maps) automatically.
     */
    ...
    protected Table getExportTable(ExportType exportType) {
        ...
        // TODO: the follow code should be removed when the 3.0 deprecated
        // methods are removed.
     ...
     * totalRows on the facade, which will set it on the Limit.
     * </p>
     *
     * <p>
     * If using the State interface then be sure to set that on the facade
     * before requesting the Limit.
     * </p>
     */
    ...
    /**
     * Set the maxRows on the facade. The max rows is the total rows that will
     * display on one page. This will override the maxRows if it was previously
     * set.
     */
    ...
    /**
     * Set the Messages on the facade. This will override the Messages if it was
     * previously set.
     */
    ...
    /**
     * Set the Preferences on the facade. This will override the Preferences if
     * it was previously set.
     */
    ...
    /**
     * Set the Table on the facade. This will override the Table if it was
     * previously set.
     */
    ...
    protected void renderExport(ExportType exportType, View view) {
        if (response == null) {
            throw new IllegalStateException("The HttpServletResponse is null. You need to call the " + "TableFacadeImpl constructor (or factory) with the response object.");
        }
    ...
    /**
     * Set the ColumnSort on the facade. This will override the ColumnSort if it
     * was previously set.
     */
     ...
     * types are ExportType.CVS, ExportType.EXCEL, ExportType.JEXCEL, and
     * ExportType.PDF.
     */
     ...
     * ExportType.PDF.
     *
     * @deprecated Use the setExportTypes() method that does not explicitly set
     * the response.
     */
    @Deprecated
    ...
    /**
     * Set the items, the Collection of Beans (or Maps).If you are performing
     * the sorting and filtering manually you should also set the
     * autoFilterAndSort() to false because there is no reason to have the API
     * try to sort and filter if you have already done so.
     *
    ...
    /**
     * Set the RowFilter on the facade. This will override the RowFilter if it
     * was previously set.
     */
     ...
     *
     * @param stateAttr The parameter that will be searched to see if the state should
     *                  be used.
     */
     ...
     * set the RowSelect on the Limit.
     *
