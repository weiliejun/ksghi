...
/**
 * The template is useful to abstract out the interaction with the TableFacade.
 * So instead of having to get the order of interaction with the TableFacade
 * right you just override the method that represents what you want to customize
 * and
 *
