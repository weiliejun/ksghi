...
public class HtmlUtils {
    ...
    /**
     * Find the starting rowcount for each page. The default is to start at 0.
     * However, if the includePagination preference
     * (html.rowcount.includePagination) is set to true then each page will
     * start at the row that corresponds with the current page.
     */
    ...
    /**
     * Look in the preferences to find out if the document.ready script should
     * be used.
     *
     * @return Is true if including the document.ready script to initialize
     * limit.
     * @since 2.2
     */
