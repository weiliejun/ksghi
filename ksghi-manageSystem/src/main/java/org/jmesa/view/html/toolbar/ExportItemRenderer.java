...
public class ExportItemRenderer extends AbstractItemRenderer {
    ...
    public String render() {
        ...
        StringBuilder action = new StringBuilder("javascript:jQuery.jmesa.setExportToLimit('" + limit.getId() + "','" + export.getExportType().toParam() + "');" + getOnInvokeActionJavaScript(limit, item));
