...
public class MaxRowsItemRenderer extends AbstractItemRenderer {
    ...
    public String render() {
        ...
        StringBuilder action = new StringBuilder("jQuery.jmesa.setMaxRowsToLimit('" + limit.getId() + "', this.options[this.selectedIndex].value);" + getOnInvokeActionJavaScript(limit, item));
