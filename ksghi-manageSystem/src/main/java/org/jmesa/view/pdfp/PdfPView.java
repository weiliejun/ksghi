...
public class PdfPView extends AbstractExportView {
    ...
    /**
     * Create either the default helvetica 12 point font, or specify the font
     * name and encoding in the preferences.
     *
     * <p>
     * The preference settings are the following: export.pdf.fontName
    ...
    /**
     * Create either the default helvetica 12 point font, or specify the font
     * name and encoding in the preferences. Either way it will use the header
     * font color.
     *
     * <p>
     * The preference settings are the following: export.pdf.fontName
