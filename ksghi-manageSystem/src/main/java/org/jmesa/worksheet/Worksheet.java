...
/**
 * <p>
 * The Worksheet represents what the user changed on the table. It will contain
 * WorksheetRows which contain WorksheetColumns. A WorksheetColumn represents
 * the edited HtmlColumn. As a developer you will use the Worksheet to know what
 * was modified, added, and deleted. You will also have a way to add an error to
 * individual columns.
 * </p>
 *
 * <p>
 * To get this functionality you will have to tell the TableModel that it is
 * editable.
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * In this example "id" is the item property that is used to uniquely identify
 * the row.
 * </p>
 *
...
public class Worksheet implements WebContextSupport, MessagesSupport, Serializable {
    ...
    /**
     * @return Is true if the worksheet contains changes, which really means the
    ...
    /**
     * @return Is true if the user is requesting that the worksheet filter
     * changes.
     */
    ...
    /**
     * A convenience method to handle the worksheet iteration. Be sure to clear
     * any previous row and column errors that no longer exist so that the
     * worksheet row is removed from the worksheet.
     *
