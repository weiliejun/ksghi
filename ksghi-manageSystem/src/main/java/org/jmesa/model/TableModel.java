...
public class TableModel {
    ...
    /**
     * Use if you need to delay calculating the items until some other action,
     * such as saving to a worksheet.
     */
    ...
    /**
     * The most common way to set the items. If you need to delay setting the
     * items then call the method with the AllItems interface.
     */
