...
/**
 * <p>
 * The SortSet is an Collection of Sort objects. A Sort contains an item
 * property and the sort Order. Or, in other words, it is simply the column that
 * the user is trying to sort in the correct order.
 * </p>
 *
...
public class SortSet implements Serializable {
    ...
    /**
     * <p>
     * For a given item property, retrieve the Sort object based on the
     * property.
     * </p>
     *
     * @param property The Sort property, which is also a column property.
