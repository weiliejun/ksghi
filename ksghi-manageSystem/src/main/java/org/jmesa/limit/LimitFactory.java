...
public class LimitFactory {
     ...
     *
     * <p>
     * Also note that if you are using the State feature the returned object
     * will be the Limit as it exists in the State.
     * </p>
     *
     * <p>
     ...
     * </p>
     *
     * @param maxRows   The maximum page rows that should be displayed on the current
     *                  page.
    ...
    /**
     * @deprecated Because the Limit is injected this is not a very good factory
     * method.
     */
    @Deprecated
     ...
     *                  be used.
     * @deprecated The State should be set directly on the Limit. This really
     * should not be a part of the interface because it is an
