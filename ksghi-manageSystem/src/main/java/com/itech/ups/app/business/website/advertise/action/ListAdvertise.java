 ...
 */
@Controller
public class ListAdvertise extends AbstractActionParent {

    @Autowired
    private AdvertiseService service;

    @RequestMapping("/business/website/advertise/list")
    public String list(HttpServletRequest request, Model model) {
        ...
        if (new Integer(params.get("size").toString()).intValue() >= 0) {
            Collection<?> items = TableModelUtils.getItems("grid", "restore", request, new PageItems() {
                public Collection<?> getItems(Limit limit) {
                    ...
                    return service.findAdvertise(params, rowStart, rowEnd);
                }

                public int getTotalRows(Limit limit) {
                    return (int) service.findAdvertisesTotalCount(params);
                }
            });
        ...
        // ////
        return "business/website/advertise/list";
    }
}