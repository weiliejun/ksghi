package com.itech.ups.base.web.components.verifycode;
...
public class VerifyCodeGenerator {
    ...
    private final String ATTRIBUTE_NAME = ApplicationConstant.PLATFORM_VERIFY_CODE;
    // 图片的宽度
    ...
    // 随机字符串范围
    private final String RAND_RANGE = "abcdefghijklmnopqrstuvwxyz" + "ABCDEFGHIJKLMNOPQRSTUVWXYZ" + "1234567890" + "@#$";
