    ...
    private void construct(Map map, int depth) {
        ...
        for (Object key : map.entrySet()) {
            ...
            if (value instanceof Map) {
                ...
                if (requestId == 0 && keyName.equalsIgnoreCase("request_id") && (value instanceof Long || value instanceof Integer)) {
                    requestId = Long.parseLong(value.toString());
                } else if (errorCode == 0 && keyName.equalsIgnoreCase("error_code") && (value instanceof Integer || value instanceof Long)) {
                    errorCode = Integer.parseInt(value.toString());
                } else if (errorMsg != null && keyName.equalsIgnoreCase("error_msg") && value instanceof String) {
