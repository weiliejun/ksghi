...
public class QueryTopicList {
    public static void main(String[] args) throws PushClientException, PushServerException {
        ...
        try {
            ...
            QueryTopicListRequest request = new QueryTopicListRequest().addStart(0).addLimit(6).addDeviceType(3);
            // 5. http request
            ...
            if (null != response) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (object instanceof TopicResultInfo) {
                        ...
                        strBuilder.append("List[" + i + "]: " + "topicId= " + topicResult.getTopicId() + ",firstPushTime= " + topicResult.getFirstPushTime() + ",lastPushTime= " + topicResult.getLastPushTime() + ",totalPushDevsNum= " + topicResult.getTotalPushDevsNum() + ",totalAckDevsNum= " + topicResult.getTotalAckDevsNum());
                    }
