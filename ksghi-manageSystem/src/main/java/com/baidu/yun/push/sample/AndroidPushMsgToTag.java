...
public class AndroidPushMsgToTag {
    public static void main(String[] args) throws PushClientException, PushServerException {
        ...
        try {
            ...
            PushMsgToTagRequest request = new PushMsgToTagRequest().addTagName("xxxxx").addMsgExpires(new Integer(3600)).addMessageType(0) // 添加透传消息
                    // .addSendTime(System.currentTimeMillis() / 1000 + 120)
                    // //设置定时任务
                    .addMessage("Hello Baidu push").addDeviceType(3);
            // 5. http request
