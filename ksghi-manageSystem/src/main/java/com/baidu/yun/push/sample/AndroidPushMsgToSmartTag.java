...
public class AndroidPushMsgToSmartTag {
    public static void main(String[] args) throws PushClientException, PushServerException {
        ...
        try { // 开放tag组合运算功能
            ...
            PushMsgToSmartTagRequest request = new PushMsgToSmartTagRequest().addSelector(selector.toString()).addMsgExpires(new Integer(3600)).addMessageType(0).addMessage("Hello Baidu push").addDeviceType(3);
            // 5. http request
