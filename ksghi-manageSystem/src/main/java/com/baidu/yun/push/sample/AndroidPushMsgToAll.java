...
public class AndroidPushMsgToAll {
    public static void main(String[] args) throws PushClientException, PushServerException {
        ...
        String apiKey = "nM7eYjMXewXYMtyI3AAS6Zl6";
        String secretKey = "tYtmERhsySa4F9ORV3g7fpXKWgdD2yom";
        ...
        try {
            ...
            PushMsgToAllRequest request = new PushMsgToAllRequest().addMsgExpires(new Integer(3600)).addMessageType(0).addMessage("Hello Baidu push") // 添加透传消息
