...
public class QueryTopicRecords {
    public static void main(String[] args) throws PushClientException, PushServerException {
        ...
        try {
            ...
            QueryTopicRecordsRequest request = new QueryTopicRecordsRequest().addTopicId("xxxxx").addStart(0).addLimit(5).
            ...
            if (null != response) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (object instanceof Record) {
                        ...
                        strBuilder.append("{msgId: " + record.getMsgId() + ", status: " + record.getMsgStatus() + ", sendTime: " + record.getSendTime() + "}\n");
                    }
                }
                strBuilder.append("}");
