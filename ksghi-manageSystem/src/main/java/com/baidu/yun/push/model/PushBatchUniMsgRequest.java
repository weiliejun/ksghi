...
public class PushBatchUniMsgRequest extends PushRequest {
    ...
    /*
     * @HttpParamKeyName(name=BaiduPushConstants.DEPLOY_STATUS,
     * param=R.OPTIONAL)
     *
     * @RangeRestrict(minLength=0, maxLength=1) private Integer deployStatus =
     * null;
     */// 不支持IOS
     ...
     * this.deployStatus = deployStatus; return this; }
     */
    ...
    /*
     * public Integer getDeployStatus () { return deployStatus; }
     */
    ...
    /*
     * public void setDeployStatus (Integer depolyStatus) { this.deployStatus =
     * depolyStatus; }
     */
