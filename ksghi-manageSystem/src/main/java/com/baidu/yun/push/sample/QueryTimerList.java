            ...
            if (null != response) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (object instanceof TimerResultInfo) {
                        ...
                        strBuilder.append("List[" + i + "]: " + "timerId= " + timerResult.getTimerId() + ",sendTime= " + timerResult.getSendTime() + ",message= " + timerResult.getMessage() + ",msgType= " + timerResult.getMsgType() + ",rangeType= " + timerResult.getRangeType() + "\n");
                    }
