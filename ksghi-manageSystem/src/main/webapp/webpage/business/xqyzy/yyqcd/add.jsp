                ...
                <div class="col-md-12">
                    <form class="form-horizontal" id="searchForm" method="post"
                        ...
                        <div class="panel panel-default">
                            ...
                            <input id="cxmk" name="cxmk" type="hidden" class="form-control" value="yyqcd"/>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <legend><i class="icon-pencil"></i>犹豫期撤单操作</legend>
                                    </h3>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">撤单时间：<i
                                            class="icons-mark-required"></i></label>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="cdsj" name="cdsj" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.cdsj }"/>
...
<script type="text/javascript">
    $().ready(function () {
        $("input[name='cdsj']").datepicker({format: 'yyyy-mm-dd'});
    });
