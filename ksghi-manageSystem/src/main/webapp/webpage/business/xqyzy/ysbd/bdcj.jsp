                    ...
                    <form class="form-horizontal" id="searchForm" method="post"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">撤件日期：<i
                                            class="icons-mark-required"></i></label>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="cjrq" name="cjrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.cjrq }"/>
...
<script type="text/javascript">
    $().ready(function () {
        $("input[name='cjrq']").datepicker({format: 'yyyy-mm-dd'});
    });
