                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="cbrq" name="cbrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.cbrq }"/>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="sxrq" name="sxrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.sxrq }"/>
                                                <span class="input-group-addon"> <span
                                                        class="glyphicon glyphicon-calendar"></span></span>
                                            </div>
                                        </div>
