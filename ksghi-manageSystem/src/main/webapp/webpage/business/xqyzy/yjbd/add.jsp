                ...
                <div class="col-md-12">
                    <form class="form-horizontal" id="searchForm" method="post"
                        ...
                        <div class="panel panel-default">
                            ...
                            <input id="cxmk" name="cxmk" type="hidden" class="form-control" value="yjbd"/>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <legend><i class="icon-pencil"></i>保单邮寄操作</legend>
                                    </h3>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="jcrq" name="jcrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.jcrq }"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control" rows="3" name="yjbz"
                                                  maxlength="1100">${xqyzy.yjbz}</textarea>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $().ready(function () {
        $("input[name='jcrq']").datepicker({format: 'yyyy-mm-dd'});
    });
