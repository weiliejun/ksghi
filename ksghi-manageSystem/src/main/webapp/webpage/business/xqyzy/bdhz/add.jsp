                    ...
                    <form class="form-horizontal" id="searchForm" method="post"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <legend><i class="icon-pencil"></i>保单回执操作</legend>
                                    </h3>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="hzqsrq" name="hzqsrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.hzqsrq }"/>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="hzlrrq" name="hzlrrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.hzlrrq }"/>
                                                <span class="input-group-addon"> <span
                                                        class="glyphicon glyphicon-calendar"></span></span>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $().ready(function () {
        $("input[name='hzqsrq']").datepicker({format: 'yyyy-mm-dd'});
        $("input[name='hzlrrq']").datepicker({format: 'yyyy-mm-dd'});
    });
