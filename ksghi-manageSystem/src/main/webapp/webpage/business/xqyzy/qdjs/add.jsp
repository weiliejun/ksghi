                    ...
                    <form class="form-horizontal" id="searchForm" method="post"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <legend><i class="icon-pencil"></i>清单结算</legend>
                                    </h3>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">清单结算：<i
                                            class="icons-mark-required"></i></label>
                                    <div class="col-md-3">
                                        <input type="radio" id="qdjszt" name="qdjszt" value="${xqyzy.qdjszt }"
                                               <c:if test="${xqyzy.qdjszt=='已结算' }">checked="checked"</c:if>/>确认结算
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="jsrq" name="jsrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xqyzy.jsrq }"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control" rows="3" name="jsbz"
                                                  maxlength="1100">${xqyzy.jsbz}</textarea>
                                    </div>
                                </div>
                            </div>
