                    ...
                    <form class="form-horizontal" id="searchForm" method="post"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <legend><i class="icon-pencil"></i>保单承保审核操作</legend>
                                    </h3>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">承保审核：<i
                                            class="icons-mark-required"></i></label>
                                    <div class="col-md-3">
                                        <itech:code property="cbshzt" code="ysbd.cbshzt" type="radio"
                                                    value="${xqyzy.cbshzt }"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">备注：</label>
                                    <div class="col-md-8">
                                        <textarea class="form-control" rows="3" name="cbbz"
                                                  maxlength="1100">${xqyzy.cbbz}</textarea>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $().ready(function () {
        $("input[name='cbrq']").datepicker({format: 'yyyy-mm-dd'});
        $("input[name='sxrq']").datepicker({format: 'yyyy-mm-dd'});
    });
