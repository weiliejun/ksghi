            ...
            <div class="row">
                <div class="col-md-10">
                    <form class="form-horizontal" id="searchForm" method="post"
                          action="${pageContext.request.contextPath}/business/insurance/audit/updatesave"
        ...
        bootbox.confirm('您确定要删除该文件吗？', function (confirmed) {
            if (confirmed) {
                ...
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/business/insurance/audit/deleteadvertisepictuefile",
