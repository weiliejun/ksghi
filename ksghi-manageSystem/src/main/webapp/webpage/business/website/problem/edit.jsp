            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" id="searchForm" method="post"
                          action="${pageContext.request.contextPath}/business/website/problem/edit/save" role="form">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input name="topic" size="30" type="text" class="form-control"
                                               value="${problem.topic }" maxlength="40"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select id="problemCategoryId" name="problemCategoryId" class="form-control">
                                            ...
                                            <c:forEach var="category" items="${categoryList}">
                                                <c:if test="${category.ID == problem.problemCategoryId}">
                                ...
                                <%-- <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <itech:code property="roleType" code="roleType"type="checkbox" value="${problem.roleType} }" />
                                    </div>
                                </div> --%>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input name="sequnum" id="sequnum" size="30" type="text" class="form-control"
                                               value="${problem.sequnum }" maxlength="10"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label"><font color="red">*</font>问题答案：</label>
                                    <!--										<div class="col-md-8">-->
                                    <!--											<textarea id="problemAnswer" name="problemAnswer" class="form-control">${problem.problemAnswer }</textarea>-->
                                    <!--										</div>-->
                                    <div class="col-md-9">
                                        <script id="editor" type="text/plain"
                                                style="width: 1024px; height: 500px;">${problem.problemAnswer }</script>
                                        ...
                                        class
                                        = "col-md-9" >
                                            <itech:code property="publishStatus" code="publishStatus" type="radio" value="${problem.publishStatus}" />
                                            < /div>
                                            < /div>
                                            < div
                                        class
