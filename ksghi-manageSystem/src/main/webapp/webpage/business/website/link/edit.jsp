            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" id="searchForm" method="post"
                          action="${pageContext.request.contextPath}/business/website/link/edit/save" role="form"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <itech:code property="type" code="link.type" type="radio"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" rows="3" name="remark"
                                                  maxlength="1100">${link.remark }</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="imgGroup">
                                    ...
                                    <div class="col-md-9" id="showFile">
                                        <a href="${pageContext.request.contextPath}${link.logo }"
...
<script type="text/javascript">
    ...
    $().ready(function () {
        ...
        nameIsExistDiv.hide();
        var nameOldVal = $("#name").val();//原始name值
        var nameIsExist = false;
        $("#name").focusout(function () {
            var nameNowVal = $("#name").val();
            if (nameNowVal != '') {
                if (nameNowVal != nameOldVal) {
                    $.ajax({
                        type: "POST",
                        async: false,
