            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" id="searchForm" method="post"
                          action="${pageContext.request.contextPath}/business/website/bulletin/edit/save"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 topic">
                                        <input name="keywords" size="100" maxlength="100" type="text"
                                               class="form-control" value="${bulletin.keywords }"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="description"
                                                  class="form-control"> ${bulletin.description}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <script id="editorContent" type="text/plain"
                                                style="width: 1024px; height: 500px;">${bulletin.content }</script>
                                        <
                                        input
                                        type = "hidden"
                                        name = "content"
                                        ...
                                        class
                                        = "col-md-9" >
                                            <itech:code property="publishStatus" code="publishStatus" type="radio" value="${bulletin.publishStatus }" />
                                            < /div>
                                            < /div>
                                            < div
                                        class
                                        ...
                                        class
                                        = "col-md-9" >
                                            <itech:code property="roleType" code="roleType" type="checkbox" value="${bulletin.roleType}" />
                                            < /div>
                                            < /div>
                                            < div
                                        class
