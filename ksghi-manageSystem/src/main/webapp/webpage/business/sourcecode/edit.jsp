                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input value="${sourceCode.id}" id="id" name="id" type="hidden"/> <input
                                            id="sourceWebsite" value="${sourceCode.sourceWebsite}" name="sourceWebsite"
                                            size="30" type="text" class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label"><i
                                    ...
                                    <div class="col-md-3">
                                        <input id="sourceName" value="${sourceCode.sourceName}" name="sourceName"
                                               size="30" type="text" class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="sourceCode" value="${sourceCode.sourceCode}" name="sourceCode"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <itech:code property="status" code="advertise.status" type="radio"
                                                    defaultValue="${sourceCode.status }"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="remark" class="form-control"
                                                  rows="3">${sourceCode.remark}</textarea>
                                    </div>
                                </div>
                            </div>
