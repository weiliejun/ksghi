            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" id="searchForm" method="post"
                          action="${pageContext.request.contextPath}/business/xqgl/xqjf/save" role="form">
                        <div class="panel panel-default">
                            ...
                            <input id="cxmk" name="cxmk" type="hidden" class="form-control" value="qdjs"/>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label"> 缴费记录： </label>
                                    <div class="col-md-8">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered">
                                                <thead>
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <legend><i class="icon-pencil"></i>续期缴费录入</legend>
                                    </h3>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">续缴日期：<i
                                            class="icons-mark-required"></i></label>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group date">
                                                <input id="xjrq" name="xjrq" type="text" class="form-control"
                                                       readonly="readonly" value="${xjrq }"/>
                                    ...
                                    <label class="col-md-2 control-label">保费(合计)：<i
                                            class="icons-mark-required"></i></label>
                                    <div class="col-md-3">
                                        <input id="xjbf" name="xjbf" type="text" class="form-control"
                                               maxlength="120"
                                               value="${xjbf}"/>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $().ready(function () {
        $("input[name='xjrq']").datepicker({format: 'yyyy-mm-dd'});
    });
