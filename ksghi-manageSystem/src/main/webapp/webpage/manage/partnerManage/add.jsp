                    ...
                    <div class="panel panel-default form-horizontal">
                        ...
                        <div class="panel-body">
                            <form class="" id="searchFormPartner" method="post"
                                  action="${pageContext.request.contextPath}/manage/partnerManage/add" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="url" name="url" type="text" class="form-control" maxlength="100"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><i
                                    ...
                                    <div class="col-md-3">
                                        <input id="ip" name="ip" type="text" class="form-control" maxlength="2000"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">法人代表：</label>
                                    <div class="col-md-3">
                                        <input id="ownerName" name="ownerName" type="text" class="form-control"
                                               maxlength="100"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="phone" name="phone" type="text" class="form-control" maxlength="50"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">传真：</label>
                                    <div class="col-md-3">
                                        <input id="fax" name="fax" type="text" class="form-control" maxlength="50"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">邮编：</label>
                                    <div class="col-md-3">
                                        <input id="post" name="post" type="text" class="form-control" maxlength="50"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><i
                                    ...
                                    <div class="col-md-3">
                                        <itech:code property="industry" code="industry" type="select" value=""/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><i
    ...
    $(function () {
        ...
        var searchFormValidatePartner = $("#searchFormPartner").validate({
            rules: {
                ...
                fax: {maxlength: 50},
                province: {required: true, maxlength: 30},
        ...
        $.areaLinkage.init('province', 'city', 'name');
    });
