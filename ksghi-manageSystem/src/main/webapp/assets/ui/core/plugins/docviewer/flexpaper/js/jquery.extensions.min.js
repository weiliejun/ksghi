...
(function(h){var A,s="",K=Math.PI,I=K/2,z="ontouchstart"in document.documentElement,M={backward:["tl","bl"],forward:["tr","br"],all:["tl","bl","tr","br"]},T=["single","double"],U={page:1,gradients:!0,duration:600,acceleration:!0,display:"double",cornerDragging:!0,when:null},L=z?{start:"touchstart",move:"touchmove",end:"touchend"}:{start:"mousedown",move:"mousemove",end:"mouseup"},V={folding:null,corners:"forward",cornerSize:100,gradients:!0,duration:600,acceleration:!0},O={0:{top:0,left:0,right:"auto",
bottom:"auto"},1:{top:0,right:0,left:"auto",bottom:"auto"}},m=function(a,b,c,d){return{css:{position:"absolute",top:a,left:b,overflow:d||"hidden","z-index":c||"auto"}}},P=function(a,b,c,d,e){var f=1-e,G=f*f*f,D=e*e*e;return l(Math.round(G*a.x+3*e*f*f*b.x+3*e*e*f*c.x+D*d.x),Math.round(G*a.y+3*e*f*f*b.y+3*e*e*f*c.y+D*d.y))},l=function(a,b){return{x:a,y:b}},u=function(a,b,c){return A&&c?" translate3d("+a+"px,"+b+"px, 0px) ":" translate("+a+"px, "+b+"px) "},v=function(a){return" rotate("+a+"deg) "},q=
function(a,b){return Object.prototype.hasOwnProperty.call(b,a)},W=function(){for(var a=["Moz","Webkit","Khtml","O","ms"],b=a.length,c="";b--;)a[b]+"Transform"in document.body.style&&(c="-"+a[b].toLowerCase()+"-");return c},Q=function(a,b,c,d,e){var f,G=[];if("-webkit-"==s){for(f=0;f<e;f++)G.push("color-stop("+d[f][0]+", "+d[f][1]+")");a.css({"background-image":"-webkit-gradient(linear, "+b.x+"% "+b.y+"%,  "+c.x+"% "+c.y+"%, "+G.join(",")+" )"})}else{b={x:b.x/100*a.width(),y:b.y/100*a.height()};c=
{x:c.x/100*a.width(),y:c.y/100*a.height()};var D=c.x-b.x;f=c.y-b.y;var h=Math.atan2(f,D),k=h-Math.PI/2,k=Math.abs(a.width()*Math.sin(k))+Math.abs(a.height()*Math.cos(k)),D=Math.sqrt(f*f+D*D);c=l(c.x<b.x?a.width():0,c.y<b.y?a.height():0);var g=Math.tan(h);f=-1/g;g=(f*c.x-c.y-g*b.x+b.y)/(f-g);c=f*g-f*c.x+c.y;b=Math.sqrt(Math.pow(g-b.x,2)+Math.pow(c-b.y,2));for(f=0;f<e;f++)G.push(" "+d[f][1]+" "+100*(b+D*d[f][0])/k+"%");a.css({"background-image":s+"linear-gradient("+-h+"rad,"+G.join(",")+")"})}},R="ontouchstart"in
window?{down:"touchstart",move:"touchmove",up:"touchend",over:"touchstart",out:"touchend"}:{down:"mousedown",move:"mousemove",up:"mouseup",over:"mouseover",out:"mouseout"},g={init:function(a){void 0===A&&(A="WebKitCSSMatrix"in window||"MozPerspective"in document.body.style,s=W());var b,c=this.data(),d=this.children();a=h.extend({width:this.width(),height:this.height()},U,a);c.opts=a;c.pageObjs={};c.pages={};c.pageWrap={};c.pagePlace={};c.pageMv=[];c.totalPages=a.pages||0;if(a.when)for(b in a.when)q(b,
a.when)&&this.bind(b,a.when[b]);this.css({position:"relative",width:a.width,height:a.height});this.turn("display",a.display);A&&(!z&&a.acceleration)&&this.transform(u(0,0,!0));for(b=0;b<d.length;b++)this.turn("addPage",d[b],b+1);this.turn("page",a.page);M=h.extend({},M,a.corners);c.eventHandlers={move:function(a){for(var b in c.pages)q(b,c.pages)&&k._eventMove.call(c.pages[b],a)},end:function(a){for(var b in c.pages)q(b,c.pages)&&k._eventEnd.call(c.pages[b],a)},start:function(a){for(var b in c.pages)if(q(b,
c.pages)&&!1===k._eventStart.call(c.pages[b],a))return!1}};h(this).bind(L.start,c.eventHandlers.start);a.cornerDragging?h(document).bind(L.move,c.eventHandlers.move).bind(L.end,c.eventHandlers.end):h(document).bind(L.end,c.eventHandlers.end);c.done=!0;return this},addPage:function(a,b){var c=!1,d=this.data(),e=d.totalPages+1;if(b)if(b==e)b=e,c=!0;else{if(b>e)throw Error('It is impossible to add the page "'+b+'", the maximum value is: "'+e+'"');}else b=e,c=!0;1<=b&&b<=e&&(d.done&&this.turn("stop"),
b in d.pageObjs&&g._movePages.call(this,b,1),c&&(d.totalPages=e),d.pageObjs[b]=h(a).addClass("turn-page p"+b),g._addPage.call(this,b),d.done&&this.turn("update"),g._removeFromDOM.call(this));return this},_addPage:function(a){var b=this.data(),c=b.pageObjs[a];if(c)if(g._necessPage.call(this,a)){if(!b.pageWrap[a]){var d="double"==b.display?this.width()/2:this.width(),e=this.height();c.css({width:d,height:e});b.pagePlace[a]=a;b.pageWrap[a]=h("<div/>",{id:"turn-page-wrapper-"+a,"class":"turn-page-wrapper",
page:a,css:{position:"absolute",overflow:"hidden",width:d,height:e}}).css(O["double"==b.display?a%2:0]);this.append(b.pageWrap[a]);b.pageObjs[a].appendTo(b.pageWrap[a])}(!a||1==g._setPageLoc.call(this,a))&&g._makeFlip.call(this,a)}else b.pagePlace[a]=0,b.pageObjs[a]&&b.pageObjs[a].detach()},hasPage:function(a){return a in this.data().pageObjs},destroy:function(){var a=this,b=this.data();b.destroying=!0;jQuery.each("end first flip last pressed released start turning turned zooming missing".split(" "),
...
2,height:this.height()}).flip({page:a,next:c&&a===b.totalPages?a-1:d||c?a+1:a-1,turn:this,duration:b.opts.duration,acceleration:b.opts.acceleration,corners:c?"all":d?"forward":"backward",backGradient:b.opts.gradients,frontGradient:b.opts.gradients,cornerDragging:b.opts.cornerDragging}).flip("disable",b.disabled).bind("pressed",g._pressed).bind("released",g._released).bind("start",g._start).bind("end",g._end).bind("flip",g._flip)}return b.pages[a]},_makeRange:function(a){var b;this.data();var c=this.turn("range");
if(c)for(b=c[0];b<=c[1];b++)g._addPage.call(this,b);a&&a()},range:function(a){var b,c,d=this.data();a=a||d.tpage||d.page;var e=g._view.call(this,a);if(!(1>a||a>d.totalPages))return e[1]=e[1]||e[0],1<=e[0]&&e[1]<=d.totalPages?(a=Math.floor(9),d.totalPages-e[1]>e[0]?(b=Math.min(e[0]-1,a),c=2*a-b):(c=Math.min(d.totalPages-e[1],a),b=2*a-c)):c=b=19,[Math.max(1,e[0]-b),Math.min(d.totalPages,e[1]+c)]},_necessPage:function(a){if(0===a)return!0;var b=this.turn("range");return a>=b[0]&&a<=b[1]},_removeFromDOM:function(){var a,
b=this.data();for(a in b.pageWrap)q(a,b.pageWrap)&&!g._necessPage.call(this,a)&&g._removePageFromDOM.call(this,a)},_removePageFromDOM:function(a){var b=this.data();if(b.pages[a]){var c=b.pages[a].data();c.f&&c.f.fwrapper&&c.f.fwrapper.detach();b.pages[a].detach();delete b.pages[a]}b.pageObjs[a]&&b.pageObjs[a].detach();b.pageWrap[a]&&(b.pageWrap[a].detach(),delete b.pageWrap[a]);delete b.pagePlace[a]},removePage:function(a){var b=this.data();b.pageObjs[a]&&(this.turn("stop"),g._removePageFromDOM.call(this,
a),delete b.pageObjs[a],g._movePages.call(this,a,-1),b.totalPages-=1,0<b.totalPages&&g._makeRange.call(this),b.page>b.totalPages&&this.turn("page",b.totalPages));return this},_movePages:function(a,b){var c,d=this.data(),e="single"==d.display,f=function(a){var c=a+b,f=c%2;d.pageObjs[a]&&(d.pageObjs[c]=d.pageObjs[a].removeClass5("page"+a).addClass5("page"+c));d.pagePlace[a]&&d.pageWrap[a]&&(d.pagePlace[c]=c,d.pageWrap[c]=d.pageWrap[a].css(O[e?0:f]).attr("page",c),d.pages[a]&&(d.pages[c]=d.pages[a].flip("options",
{page:c,next:e||f?c+1:c-1,corners:e?"all":f?"forward":"backward"})),b&&(delete d.pages[a],delete d.pagePlace[a],delete d.pageObjs[a],delete d.pageWrap[a],delete d.pageObjs[a]))};if(0<b)for(c=d.totalPages;c>=a;c--)f(c);else for(c=a;c<=d.totalPages;c++)f(c)},display:function(a){var b=this.data(),c=b.display;if(a){if(-1==h.inArray(a,T))throw Error('"'+a+'" is not a value for display');"single"==a?b.pageObjs[0]||(this.turn("stop").css({overflow:"hidden"}),b.pageObjs[0]=h("<div />",{"class":"turn-page p-temporal"}).css({width:this.width(),
height:this.height(),"background-color":"#ffffff"}).appendTo(this)):b.pageObjs[0]&&(this.turn("stop").css({overflow:""}),b.pageObjs[0].detach());b.display=a;c&&(a=this.turn("size"),g._movePages.call(this,1,0),this.turn("size",a.width,a.height).turn("update"));return this}return c},animating:function(){return 0<this.data().pageMv.length},cornerActivated:function(){var a,b=this.data();for(a in b.pages)if(q(a,b.pages)&&b.pages[a].data().f.hoveringCorner)return!0;return!1},disable:function(a){var b,c=
this.data(),d=this.turn("view");c.disabled=void 0===a||!0===a;for(b in c.pages)q(b,c.pages)&&c.pages[b].flip("disable",a?h.inArray(b,d):!1);return this},setCornerDragging:function(a){var b,c=this.data();this.turn("view");c.opts.cornerDragging=a;for(b in c.pages)q(b,c.pages)&&(c.pages[b].data().f.opts.cornerDragging=a)},size:function(a,b,c){if(a&&b){this.turn("stop");var d=this.data(),e="double"==d.display?a/2:a,f;if(c)for(f in this.css({width:a,height:b}),d.pageObjs[0]&&d.pageObjs[0].css({width:e,
height:b}),d.pageWrap)q(f,d.pageWrap)&&(d.pageWrap[f].css({width:e,height:b}),d.pageObjs[f].width(),d.pageObjs[f].animate({width:e,height:b},{duration:700,step:function(a,b){}}),d.pages[f]&&d.pages[f].css({width:e,height:b}));else for(f in this.css({width:a,height:b}),d.pageObjs[0]&&d.pageObjs[0].css({width:e,height:b}),d.pageWrap)q(f,d.pageWrap)&&(d.pageObjs[f].css({width:e,height:b}),d.pageWrap[f].css({width:e,height:b}),d.pages[f]&&d.pages[f].css({width:e,height:b}));this.turn("resize");return this}return{width:this.width(),
height:this.height()}},resize:function(){var a,b=this.data();b.pages[0]&&(b.pageWrap[0].css({left:-this.width()}),b.pages[0].flip("resize",!0));for(a=1;a<=b.totalPages;a++)b.pages[a]&&b.pages[a].flip("resize",!0);g._updateShadow.call(this)},_removeMv:function(a){var b,c=this.data();for(b=0;b<c.pageMv.length;b++)if(c.pageMv[b]==a)return c.pageMv.splice(b,1),!0;return!1},_addMv:function(a){var b=this.data();g._removeMv.call(this,a);b.pageMv.push(a)},_view:function(a){var b=this.data();a=a||b.page;return"double"==
b.display?a%2?[a-1,a]:[a,a+1]:[a]},view:function(a){var b=this.data();a=g._view.call(this,a);return"double"==b.display?[0<a[0]?a[0]:0,a[1]<=b.totalPages?a[1]:0]:[0<a[0]&&a[0]<=b.totalPages?a[0]:0]},stop:function(a){var b,c=this.data(),d=c.pageMv;c.pageMv=[];c.tpage&&(c.page=c.tpage,delete c.tpage);for(b in d)q(b,d)&&(k._moveFoldingPage.call(c.pages[d[b]],null),k.hideFoldedPage.call(c.pages[d[b]],!1),a=c.pages[d[b]].data().f.opts,c.pagePlace[a.next]=a.next,a.force&&(a.next=0===a.page%2?a.page-1:a.page+
1,delete a.force));this.turn("update");return this},pages:function(a){var b=this.data();if(a){if(a<b.totalPages){for(var c=a+1;c<=b.totalPages;c++)this.turn("removePage",c);this.turn("page")>a&&this.turn("page",a)}b.totalPages=a;return this}return b.totalPages},_fitPage:function(a,b){var c=this.data(),d=this.turn("view",a);c.page!=a&&(this.trigger("turning",[a,d]),-1!=h.inArray(1,d)&&this.trigger("first"),-1!=h.inArray(c.totalPages,d)&&this.trigger("last"));c.pageObjs[a]&&(c.tpage=a,this.turn("stop",
b),g._removeFromDOM.call(this),g._makeRange.call(this),g._updateShadow.call(this),this.trigger("turned",[a,d]))},_missing:function(a){var b=this.data(),c=this.turn("range",a),d=[];for(a=c[0];a<=c[1];a++)b.pageObjs[a]||d.push(a);0<d.length&&this.trigger("missing",[d])},_turnPage:function(a){var b,c,d=this.data(),e=this.turn("view"),f=this.turn("view",a);d.page!=a&&(this.trigger("turning",[a,f]),-1!=h.inArray(1,f)&&this.trigger("first"),-1!=h.inArray(d.totalPages,f)&&this.trigger("last"));d.pageObjs[a]&&
(d.tpage=a,"single"==d.display?(b=e[0],c=f[0]):e[1]&&a>e[1]?(b=e[1],c=f[0]):e[0]&&a<e[0]&&(b=e[0],c=f[1]),this.turn("stop"),g._makeRange.call(this),d.pages[b]&&(a=d.pages[b].data().f.opts,d.tpage=c,a.next!=c&&(a.next=c,d.pagePlace[c]=a.page,a.force=!0),"single"==d.display?d.pages[b].flip("turnPage",f[0]>e[0]?"br":"bl"):d.pages[b].flip("turnPage")))},page:function(a){a=parseInt(a,10);var b=this.data();return 0<a&&a<=b.totalPages?(!b.done||-1!=h.inArray(a,this.turn("view"))?g._fitPage.call(this,a):
g._turnPage.call(this,a),this):b.page},next:function(){var a=this.data();return this.turn("page",g._view.call(this,a.page).pop()+1)},previous:function(){var a=this.data();return this.turn("page",g._view.call(this,a.page).shift()-1)},_addMotionPage:function(){var a=h(this).data().f.opts,b=a.turn,c=b.data();a.pageMv=a.page;g._addMv.call(b,a.pageMv);c.pagePlace[a.next]=a.page;b.turn("update")},_start:function(a,b,c){var d=b.turn.data(),e=h.Event("start");a.stopPropagation();b.turn.trigger(e,[b,c]);e.isDefaultPrevented()?
a.preventDefault():("single"==d.display&&(c="l"==c.charAt(1),1==b.page&&c||b.page==d.totalPages&&!c?a.preventDefault():c?(b.next=b.next<b.page?b.next:b.page-1,b.force=!0):b.next=b.next>b.page?b.next:b.page+1),g._addMotionPage.call(this),(1==b.next||b.next==d.totalPages&&0==d.totalPages%2)&&g._updateShadow.call(b.turn))},_end:function(a,b){var c=h(this).data().f.opts,d=c.turn,e=d.data();a.stopPropagation();if(b||e.tpage){if(e.tpage==c.next||e.tpage==c.page)delete e.tpage,g._fitPage.call(d,e.tpage||
c.next,!0)}else z&&g._removeMv.call(d,c.pageMv),d.turn("update")},_pressed:function(){var a=h(this).data().f;a.opts.turn.data();return a.time=(new Date).getTime()},_released:function(a,b){var c=h(this),d=c.data().f;a.stopPropagation();200>(new Date).getTime()-d.time||0>b.x||b.x>h(this).width()?(a.preventDefault(),d.opts.turn.data().tpage=d.opts.next,d.opts.turn.turn("update"),h(c).flip("turnPage")):jQuery(this).removeClass5("flexpaper_page_zoomIn").removeClass5("flexpaper_page_zoomOut").addClass5("flexpaper_page_dragPage")},
_flip:function(){var a=h(this).data().f.opts;a.turn.trigger("turn",[a.next])},calculateZ:function(a){var b,c,d,e,f=this,h=this.data();b=this.turn("view");var k=b[0]||b[1],g={pageZ:{},partZ:{},pageV:{}},l=function(a){a=f.turn("view",a);a[0]&&(g.pageV[a[0]]=!0);a[1]&&(g.pageV[a[1]]=!0)};for(b=0;b<a.length;b++)c=a[b],d=h.pages[c].data().f.opts.next,e=h.pagePlace[c],l(c),l(d),c=h.pagePlace[d]==d?d:c,g.pageZ[c]=h.totalPages-Math.abs(k-c),g.partZ[e]=2*h.totalPages+Math.abs(k-c);return g},update:function(){var a,
b=this.data();if(b.pageMv.length&&0!==b.pageMv[0]){var c=this.turn("calculateZ",b.pageMv);this.turn("view",b.tpage);for(a in b.pageWrap)q(a,b.pageWrap)&&(b.pageWrap[a].css({display:c.pageV[a]?"":"none","z-index":c.pageZ[a]||0}),b.pages[a]&&(b.pages[a].flip("z",c.partZ[a]||null),c.pageV[a]&&b.pages[a].flip("resize"),b.tpage&&b.pages[a].flip("disable",!0)))}else for(a in b.pageWrap)q(a,b.pageWrap)&&(c=g._setPageLoc.call(this,a),b.pages[a]&&b.pages[a].flip("disable",b.disabled||1!=c).flip("z",null))},
_updateShadow:function(){var a=this.data(),b=this.turn("view"),c=this.width(),d=this.height(),e="single"==a.display?c:c/2;a.shadow||(a.shadow=h("<div />",{"class":"flexpaper_shadow",css:m(0,0,0).css}).appendTo(this));b[0]==a.totalPages&&0==a.totalPages%2?a.shadow.css({width:e,height:d,top:0,left:0}):0==b[0]?a.shadow.css({width:e,height:d,top:0,left:e}):a.shadow.css({width:c,height:d,top:0,left:0})},_setPageLoc:function(a){var b=this.data(),c=this.turn("view");if(a==c[0]||a==c[1])return b.pageWrap[a].css({"z-index":b.totalPages,
display:""}),1;if("single"==b.display&&a==c[0]+1||"double"==b.display&&a==c[0]-2||a==c[1]+2)return b.pageWrap[a].css({"z-index":b.totalPages-1,display:""}),2;b.pageWrap[a].css({"z-index":0,display:"none"});return 0}},k={init:function(a){a.gradients&&(a.frontGradient=!0,a.backGradient=!0);this.data({f:{}});this.flip("options",a);k._addPageWrapper.call(this);return this},setData:function(a){var b=this.data();b.f=h.extend(b.f,a);return this},options:function(a){var b=this.data().f;return a?(k.setData.call(this,
{opts:h.extend({},b.opts||V,a)}),this):b.opts},z:function(a){var b=this.data().f;b.opts["z-index"]=a;b.fwrapper.css({"z-index":a||parseInt(b.parent.css("z-index"),10)||0});return this},_cAllowed:function(){return M[this.data().f.opts.corners]||this.data().f.opts.corners},_cornerActivated:function(a){if(void 0===a.originalEvent)return!1;a=z?a.originalEvent.touches:[a];var b=this.data().f,c=b.parent.offset(),d=this.width(),e=this.height();a={x:Math.max(0,a[0].pageX-c.left),y:Math.max(0,a[0].pageY-c.top)};
b=b.opts.cornerSize;c=k._cAllowed.call(this);if(0>=a.x||0>=a.y||a.x>=d||a.y>=e)return!1;if(a.y<b)a.corner="t";else if(a.y>=e-b)a.corner="b";else return!1;if(a.x<=b)a.corner+="l";else if(a.x>=d-b)a.corner+="r";else return!1;(d=-1==h.inArray(a.corner,c)?!1:a)&&this.trigger("cornerActivated");return d},_c:function(a,b){var c=this.width(),d=this.height();b=b||0;return{tl:l(b,b),tr:l(c-b,b),bl:l(b,d-b),br:l(c-b,d-b)}[a]},_c2:function(a){var b=this.width(),c=this.height();return{tl:l(2*b,0),tr:l(-b,0),
bl:l(2*b,c),br:l(-b,c)}[a]},_foldingPage:function(a){a=this.data().f.opts;if(a.folding)return a.folding;if(a.turn){var b=a.turn.data();return"single"==b.display?b.pageObjs[a.next]?b.pageObjs[0]:null:b.pageObjs[a.next]}},_backGradient:function(){var a=this.data().f,b=a.opts.turn;if((b=a.opts.backGradient&&(!b||"single"==b.data().display||2!=a.opts.page&&a.opts.page!=b.data().totalPages-1))&&!a.bshadow)a.bshadow=h("<div/>",m(0,0,1)).css({position:"",width:this.width(),height:this.height()}).appendTo(a.parent);
return b},resize:function(a){var b=this.data().f,c=this.width(),d=this.height(),e=Math.round(Math.sqrt(Math.pow(c,2)+Math.pow(d,2)));a&&(b.wrapper.css({width:e,height:e}),b.fwrapper.css({width:e,height:e}).children(":first-child").css({width:c,height:d}),b.fpage.css({width:d,height:c}),b.opts.frontGradient&&b.ashadow.css({width:d,height:c}),k._backGradient.call(this)&&b.bshadow.css({width:c,height:d}));b.parent.is(":visible")&&(b.fwrapper.css({top:b.parent.offset().top,left:b.parent.offset().left}),
b.opts.turn&&b.fparent.css({top:-b.opts.turn.offset().top,left:-b.opts.turn.offset().left}));this.flip("z",b.opts["z-index"])},_addPageWrapper:function(){var a=this.data().f,b=this.parent();if(!a.wrapper){this.css("left");this.css("top");var c=this.width(),d=this.height();Math.round(Math.sqrt(Math.pow(c,2)+Math.pow(d,2)));a.parent=b;a.fparent=a.opts.turn?a.opts.turn.data().fparent:h("#turn-fwrappers");a.fparent||(c=h("<div/>",{css:{"pointer-events":"none"}}).hide(),c.data().flips=0,a.opts.turn?(c.css(m(-a.opts.turn.offset().top,
-a.opts.turn.offset().left,"auto","visible").css).appendTo(a.opts.turn),a.opts.turn.data().fparent=c):c.css(m(0,0,"auto","visible").css).attr("id","turn-fwrappers").appendTo(h("body")),a.fparent=c);this.css({position:"absolute",top:0,left:0,bottom:"auto",right:"auto"});a.wrapper=h("<div/>",m(0,0,this.css("z-index"))).appendTo(b).prepend(this);a.fwrapper=h("<div/>",m(b.offset().top,b.offset().left)).hide().appendTo(a.fparent);a.fpage=h("<div/>",{css:{cursor:"default"}}).appendTo(h("<div/>",m(0,0,0,
"visible")).appendTo(a.fwrapper));b=a.opts&&a.opts.turn&&"single"!=a.opts.turn.data().display?'style="position:absolute;z-index:10;-webkit-backface-visibility:hidden;"':"";a.opts.frontGradient&&(a.ashadow=h("<div "+b+"/>",m(0,0,1)).appendTo(a.fpage));k.setData.call(this,a);k.resize.call(this,!0)}},_fold:function(a){var b=this,c=0,d=0,e,f,h,g,x,q,B=l(0,0),N=l(0,0),n=l(0,0),t=this.width(),w=this.height(),m=k._foldingPage.call(this);Math.tan(d);var r=this.data().f,y=r.opts.acceleration,z=r.wrapper.height(),
s=k._c.call(this,a.corner),H="t"==a.corner.substr(0,1),E="l"==a.corner.substr(1,1),J=function(){var p=l(s.x?s.x-a.x:a.x,s.y?s.y-a.y:a.y),F=Math.atan2(p.y,p.x),C;d=I-F;c=180*(d/K);C=l(E?t-p.x/2:a.x+p.x/2,p.y/2);var m=d-Math.atan2(C.y,C.x),m=Math.max(0,Math.sin(m)*Math.sqrt(Math.pow(C.x,2)+Math.pow(C.y,2)));n=l(m*Math.sin(d),m*Math.cos(d));if(d>I&&(n.x+=Math.abs(n.y*Math.tan(F)),n.y=0,Math.round(n.x*Math.tan(K-d))<w))return a.y=Math.sqrt(Math.pow(w,2)+2*C.x*p.x),H&&(a.y=w-a.y),J();d>I&&(p=K-d,F=z-w/
Math.sin(p),B=l(Math.round(F*Math.cos(p)),Math.round(F*Math.sin(p))),E&&(B.x=-B.x),H&&(B.y=-B.y));e=Math.round(n.y/Math.tan(d)+n.x);p=t-e;F=p*Math.cos(2*d);C=p*Math.sin(2*d);N=l(Math.round(E?p-F:e+F),Math.round(H?C:w-C));x=p*Math.sin(d);p=k._c2.call(b,a.corner);p=Math.sqrt(Math.pow(p.x-a.x,2)+Math.pow(p.y-a.y,2));q=p<t?p/t:1;r.opts.frontGradient&&(g=100<x?(x-100)/x:0,f=l(100*(x*Math.sin(I-d)/w),100*(x*Math.cos(I-d)/t)),H&&(f.y=100-f.y),E&&(f.x=100-f.x));k._backGradient.call(b)&&(h=l(100*(x*Math.sin(d)/
t),100*(x*Math.cos(d)/w)),E||(h.x=100-h.x),H||(h.y=100-h.y));n.x=Math.round(n.x);n.y=Math.round(n.y);return!0},A=function(a,c,e,n){var m=["0","auto"],x=(t-z)*e[0]/100,s=(w-z)*e[1]/100;c={left:m[c[0]],top:m[c[1]],right:m[c[2]],bottom:m[c[3]]};m=90!=n&&-90!=n?E?-1:1:0;e=e[0]+"% "+e[1]+"%";b.css(c).transform(v(n)+u(a.x+m,a.y,y),e);r.fpage.parent().css(c);r.fpage.css({"-webkit-box-shadow":String.format("rgba(0, 0, 0, {0}) 0px 0px 20px",0.25<g?g:0.25),"-moz-box-shadow":String.format("rgba(0, 0, 0, {0}) 0px 0px 20px",
0.25<g?g:0.25),"-ms-box-shadow":String.format("rgba(0, 0, 0, {0}) 0px 0px 20px",0.25<g?g:0.25),"-o-box-shadow":String.format("rgba(0, 0, 0, {0}) 0px 0px 20px",0.25<g?g:0.25),"box-shadow":String.format("rgba(0, 0, 0, {0}) 0px 0px 20px",0.25<g?g:0.25),"-webkit-transition":"-webkit-box-shadow 2s","-moz-transition":"-moz-box-shadow 2s","-o-transition":"-webkit-box-shadow 2s","-ms-transition":"-ms-box-shadow 2s"});r.wrapper.transform(u(-a.x+x-m,-a.y+s,y)+v(-n),e);r.fwrapper.transform(u(-a.x+B.x+x,-a.y+
B.y+s,y)+v(-n),e);r.fpage.parent().transform(v(n)+u(a.x+N.x-B.x,a.y+N.y-B.y,y),e);r.opts.frontGradient&&Q(r.ashadow,l(E?100:0,H?100:0),l(f.x,f.y),[[g,"rgba(0,0,0,0)"],[0.8*(1-g)+g,"rgba(0,0,0,"+0.2*q+")"],[1,"rgba(255,255,255,"+0.2*q+")"]],3,d);k._backGradient.call(b)&&Q(r.bshadow,l(E?0:100,H?0:100),l(h.x,h.y),[[0.8,"rgba(0,0,0,0)"],[1,"rgba(0,0,0,"+0.3*q+")"],[1,"rgba(0,0,0,0)"]],3)};switch(a.corner){case "tl":a.x=Math.max(a.x,1);J();A(n,[1,0,0,1],[100,0],c);r.fpage.transform(u(-w,-t,y)+v(90-2*c),
"100% 100%");m.transform(v(90)+u(0,-w,y),"0% 0%");break;case "tr":a.x=Math.min(a.x,t-1);J();A(l(-n.x,n.y),[0,0,0,1],[0,0],-c);r.fpage.transform(u(0,-t,y)+v(-90+2*c),"0% 100%");m.transform(v(270)+u(-t,0,y),"0% 0%");break;case "bl":a.x=Math.max(a.x,1);J();A(l(n.x,-n.y),[1,1,0,0],[100,100],-c);r.fpage.transform(u(-w,0,y)+v(-90+2*c),"100% 0%");m.transform(v(270)+u(-t,0,y),"0% 0%");break;case "br":a.x=Math.min(a.x,t-1),J(),A(l(-n.x,-n.y),[0,1,1,0],[0,100],c),r.fpage.transform(v(90-2*c),"0% 0%"),m.transform(v(90)+
u(0,-w,y),"0% 0%")}r.point=a},_moveFoldingPage:function(a){var b=this.data().f,c=k._foldingPage.call(this);if(c)if(a){if(!b.fpage.children()[b.ashadow?"1":"0"])k.setData.call(this,{backParent:c.parent()}),b.fpage.prepend(c)}else b.backParent&&b.backParent.prepend(c)},_showFoldedPage:function(a,b){var c=k._foldingPage.call(this),d=this.data(),e=d.f;if(!e.point||e.point.corner!=a.corner){var f=h.Event("start");this.trigger(f,[e.opts,a.corner]);if(f.isDefaultPrevented())return!1}this.removeClass5("flexpaper_page_zoomIn").removeClass5("flexpaper_page_zoomOut").addClass5("flexpaper_page_dragPage");
if(c){if(b){var g=this,c=e.point&&e.point.corner==a.corner?e.point:k._c.call(this,a.corner,1);this.animatef({from:[c.x,c.y],to:[a.x,a.y],duration:500,frame:function(b){a.x=Math.round(b[0]);a.y=Math.round(b[1]);k._fold.call(g,a)}})}else k._fold.call(this,a),d.effect&&!d.effect.turning&&this.animatef(!1);"none"==e.fwrapper[0].style.display&&(e.fparent.show().data().flips++,k._moveFoldingPage.call(this,!0),e.fwrapper.show(),e.bshadow&&e.bshadow.show());return!0}return!1},hide:function(){var a=this.data().f,
b=k._foldingPage.call(this);0===--a.fparent.data().flips&&a.fparent.hide();this.css({left:0,top:0,right:"auto",bottom:"auto"}).transform("");a.wrapper.transform("");a.fwrapper.hide();a.bshadow&&a.bshadow.hide();b.transform("");return this},hideFoldedPage:function(a){var b=this.data().f;this.removeClass5("flexpaper_page_dragPage").removeClass5("flexpaper_page_zoomOut").addClass5("flexpaper_page_zoomIn");if(b.point){b.hoveringCorner=!1;var c=this,d=b.point,e=function(){b.point=null;c.flip("hide");c.trigger("end",
[!1])};if(a){var f=k._c.call(this,d.corner);a="t"==d.corner.substr(0,1)?Math.min(0,d.y-f.y)/2:Math.max(0,d.y-f.y)/2;var g=l(d.x,d.y+a),h=l(f.x,f.y-a);this.animatef({from:0,to:1,frame:function(a){a=P(d,g,h,f,a);d.x=a.x;d.y=a.y;k._fold.call(c,d)},complete:e,duration:800,hiding:!0})}else this.animatef(!1),e()}},turnPage:function(a){var b=this,c=this.data().f;a={corner:c.corner?c.corner.corner:a||k._cAllowed.call(this)[0]};var d=c.point||k._c.call(this,a.corner,c.opts.turn?c.opts.turn.data().opts.elevation:
0),e=k._c2.call(this,a.corner);this.trigger("flip").animatef({from:0,to:1,frame:function(c){c=P(d,d,e,e,c);a.x=c.x;a.y=c.y;k._showFoldedPage.call(b,a)},complete:function(){b.trigger("end",[!0])},duration:c.opts.duration,turning:!0});c.corner=null},moving:function(){return"effect"in this.data()},isTurning:function(){return this.flip("moving")&&this.data().effect.turning},_eventStart:function(a){var b=this.data().f;if(!b.disabled&&!this.flip("isTurning")){b.corner=k._cornerActivated.call(this,a);if(b.corner&&
k._foldingPage.call(this,b.corner))return k._moveFoldingPage.call(this,!0),this.trigger("pressed",[b.point]),!1;b.corner=null}},_eventMove:function(a){var b=this.data().f;if(b&&!b.disabled&&b.opts.cornerDragging)if(a=z?a.originalEvent.touches:[a],b.corner&&!this.flip("isTurning")){var c=b.parent.offset();b.corner.x=a[0].pageX-c.left;b.corner.y=a[0].pageY-c.top;k._showFoldedPage.call(this,b.corner)}else!this.data().effect&&this.is(":visible")&&((a=k._cornerActivated.call(this,a[0]))&&!this.flip("isTurning")?
(c=k._c.call(this,a.corner,b.opts.cornerSize/2),a.x=c.x,a.y=c.y,b.hoveringCorner=!0,k._showFoldedPage.call(this,a,!0)):k.hideFoldedPage.call(this,!0))},_eventEnd:function(){var a=this.data().f;if(a&&!a.disabled&&a.point){var b=h.Event("released");this.trigger(b,[a.point]);b.isDefaultPrevented()||k.hideFoldedPage.call(this,!0)}a&&(a.corner=null)},disable:function(a){k.setData.call(this,{disabled:a});return this}},S=function(a,b,c){if(!c[0]||"object"==typeof c[0])return b.init.apply(a,c);if(b[c[0]]&&
"_"!=c[0].toString().substr(0,1))return b[c[0]].apply(a,Array.prototype.slice.call(c,1));throw c[0]+" is an invalid value";};window.requestAnim=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)};h.extend(h.fn,{flip:function(a,b){return S(this,k,arguments)},turn:function(a){return S(this,g,arguments)},transform:function(a,b){var c={};b&&(c[s+"transform-origin"]=
b);c[s+"transform"]=a;return this.css(c)},animatef:function(a){var b=this.data();b.effect&&b.effect.stop();if(a){a.to.length||(a.to=[a.to]);a.from.length||(a.from=[a.from]);a.easing||(a.easing=function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c});var c,d=[],e=a.to.length,f=this,g=a.fps||30,k=-g,l=!0,m=function(){if(b.effect&&l){var c,h=[];k=Math.min(a.duration,k+g);for(c=0;c<e;c++)h.push(a.easing(1,k,a.from[c],d[c],a.duration));a.frame(1==e?h[0]:h);k==a.duration?(delete b.effect,f.data(b),a.complete&&
a.complete()):window.requestAnim(m)}};for(c=0;c<e;c++)d.push(a.to[c]-a.from[c]);b.effect=h.extend({stop:function(){l=!1},easing:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c}},a);this.data(b);m()}else delete b.effect}});h.isTouch=z})(jQuery);
