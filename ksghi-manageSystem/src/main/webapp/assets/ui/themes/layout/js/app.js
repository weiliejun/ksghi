...
//cg add
if (d.items){
   Ext.Array.forEach(d.items, function (e) {
...
Ext.define("Docs.view.Tabs", {
    ...
    initComponent: function () {
        ...
        this.tpl = Ext.create("Ext.XTemplate", '<tpl for=".">', '<div class="doctab overview {cls}{active}">', '<div class="l"></div>', '<div class="m">', '<tpl if="text">', '<a class="tabUrl ov-tab-text" href="{href}">{text}</a>', "<tpl else>", '<a class="tabUrl ov-tab" href="{href}">&nbsp;</a>', "</tpl>", "</div>", '<div class="r"></div>', "</div>", "</tpl>", '<div style="float: left; width: 142px">&nbsp;</div>', '<div class="tab-overflow"></div>');
...
Ext.define("Docs.view.examples.Index", {
    ...
    initComponent: function () {
        ...
        this.items = [{
                xtype: "container",
                //html: '<h1 class="eg">功能菜单</h1>'
		html: ''
            }//,
            //Ext.create("Docs.view.ThumbList", {
            //    itemTpl: ['<dd ext:url="#!/example/{name}">', '', "<div><h4>{title}", "<tpl if=\"status === 'new'\">", '<span class="new-sample"> (New)</span>', "</tpl>", "<tpl if=\"status === 'updated'\">", '<span class="updated-sample"> (Updated)</span>', "</tpl>", "<tpl if=\"status === 'experimental'\">", '<span class="new-sample"> (Experimental)</span>', "</tpl>", "</h4><p>{description}</p></div>", "</dd>"],
...
Ext.define("Docs.view.Viewport", {
    ...
    requires: [ "Docs.view.Header", "Docs.view.Tabs", "Docs.view.TreeContainer", "Docs.view.welcome.Index","Docs.view.cls.Index", "Docs.view.cls.Container", "Docs.view.guides.Index", "Docs.view.guides.Container", "Docs.view.videos.Index", "Docs.view.videos.Container", "Docs.view.examples.Index", "Docs.view.examples.Container", "Docs.view.examples.TouchContainer", "Docs.view.tests.Index"],
    id: "viewport",
    layout: "border",
    defaults: {
        xtype: "container"
...
Ext.define("Docs.Application", {
    requires: ["Ext.app.Application", "Docs.History", "Docs.Settings", "Docs.view.Viewport", "Docs.controller.Welcome", "Docs.controller.Tabs"],
    constructor: function () {
    ...
    createApp: function () {
        new Ext.app.Application({
            name: "Docs",
            controllers: ["Welcome",  "Examples", "Tabs"],
            launch: this.launch
        })
    },
    launch: function () {
